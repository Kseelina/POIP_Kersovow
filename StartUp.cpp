...
0,
xPortPendSVHandler,
OsWrapper::Rtos::HandleSysTickInterrupt, // системный таймер
//External Interrupts
...
InterruptHandler::DummyHandler,
InterruptHandler::DummyHandler,
InterruptHandler::DummyHandler, // UART2, 38 строка от системного таймера
InterruptHandler::DummyHandler,
...
InterruptHandler::DummyHandler,
InterruptHandler::DummyHandler,
InterruptHandler::DummyHandler, // TIM5, 50 строкa от системного таймера (по библии на file:///R:/POIP/POIP/stm32f411_1.pdf)
InterruptHandler::DummyHandler,
InterruptHandler::DummyHandler,
InterruptHandler::DummyHandler,
InterruptHandler::DummyHandler,
